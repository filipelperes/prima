...
export function AppHeader({ onSearchClick }: AppHeaderProps) {
  return (
    <div className="flex items-start justify-between gap-3 p-4 mt-6 mb-3 bg-surface/75 backdrop-blur-lg border border-border-custom rounded-xl max-md:p-3 max-sm:mx-2.5 max-sm:p-2.5 max-sm:gap-2">
